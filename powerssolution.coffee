...
CatZoomHelper = {
  ...
  #Powers' solution was to reverse the order the queries are registered in.
  #Ultimately the issue here is the matchMedia API fires off handlers in a non-consistent order.
